        ...
        <div className="bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    {tools.map((tool) => (
                        <div key={tool.id} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow border border-gray-100 group cursor-pointer">
                            ...
                            <div className="mt-auto">
                                <span className="text-blue-600 text-sm font-medium group-hover:underline">Open Calculator &rarr;</span>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="mt-12 p-6 bg-blue-50 rounded-lg border border-blue-100 text-center">
                    <h3 className="text-lg font-semibold text-blue-900 mb-2">Need a Custom Financial Plan?</h3>
                    <p className="text-blue-800 mb-4">Calculators provide estimates. For precise financial planning, consult our experts.</p>
