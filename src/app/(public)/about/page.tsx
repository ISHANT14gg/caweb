    ...
    return (
        <div className="bg-white">
            ...
            <div className="relative h-64 md:h-80 w-full overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-navy-deep/70 flex flex-col justify-center items-center text-white">
            ...
            <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <ScrollAnimation direction="left">
                        <div className="relative h-[500px] w-full rounded-lg overflow-hidden shadow-xl">
                            <Image
                                ...
                                className="object-cover"
                            />
                            <div className="absolute bottom-10 left-10 bg-navy-deep text-white p-6 rounded-lg max-w-xs">
                                <p className="text-4xl font-bold text-gold mb-1">29 <span className="text-xl">+</span></p>
                    ...
                    <ScrollAnimation direction="right">
                        <span className="text-gold font-bold tracking-wider text-sm uppercase mb-2 block">About Us</span>
                        ...
                        <Link href="/contact" className="inline-flex items-center px-8 py-3 bg-gold text-navy-deep font-bold rounded hover:brightness-110 transition-all shadow-md">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        <ScrollAnimation direction="up">
                            <span className="text-gold font-bold tracking-wider text-sm uppercase mb-2 block">Our Mission & Vision</span>
                            <h2 className="text-3xl md:text-4xl font-bold mb-10">Discover The Core Principles That Guide Us</h2>

                            <div className="relative h-64 w-full bg-navy rounded-lg overflow-hidden flex items-center justify-center group cursor-pointer hover:bg-navy-light transition-colors border border-navy-light">
                                {/* Video Placeholder */}
                        ...
                        <div className="flex flex-col justify-center space-y-8">
                            <ScrollAnimation delay={0.2} type="fade">
                                <div className="bg-white/5 p-8 rounded border border-white/10 hover:border-gold/50 transition-colors">
                    ...
                    <div className="mt-20 pt-10 border-t border-white/10 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                        {[
                            ...
                            <ScrollAnimation key={i} delay={i * 0.1} type="scale">
                                <p className="text-4xl font-bold text-white mb-1">{stat.val} <span className="text-gold">{stat.suffix || "+"}</span></p>
            ...
            <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    <ScrollAnimation className="lg:col-span-1" direction="right">
                        <span className="text-gold font-bold tracking-wider text-sm uppercase mb-2 block">Meet The Experts</span>
                        ...
                        <Link href="/contact" className="inline-flex items-center px-6 py-3 bg-gold text-navy-deep font-bold rounded hover:brightness-110 transition-all shadow-md">
                    ...
                    <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <ScrollAnimation direction="up" delay={0.1}>
                            <div className="group relative overflow-hidden rounded-lg h-[400px] shadow-lg">
                                ...
                                />
                                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy-deep to-transparent p-6 translate-y-4 group-hover:translate-y-0 transition-transform">
                                    <p className="text-white font-bold text-lg">Aryan Singh</p>
                                    <p className="text-gold text-sm">Managing Partner</p>
                                </div>
                            </div>
                        </ScrollAnimation>
                        ...
                        <ScrollAnimation direction="up" delay={0.2}>
                            <div className="group relative overflow-hidden rounded-lg h-[400px] shadow-lg">
                                ...
                                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy-deep to-transparent p-6 translate-y-4 group-hover:translate-y-0 transition-transform">
                                    ...
                                    <p className="text-gold text-sm">Tax Specialist</p>
                                </div>
                            </div>
                        </ScrollAnimation>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <ScrollAnimation className="flex flex-col md:flex-row items-center justify-between gap-12" direction="up">
                        <div className="max-w-2xl">
                            ...
                            <Link href="/contact" className="inline-flex items-center px-8 py-4 bg-gold text-navy-deep font-bold rounded hover:brightness-110 transition-all shadow-lg">
            ...
            <div className="bg-navy py-12 border-t border-navy-light">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center text-white">
                    <div>
                        ...
                        <p className="text-gray-400 text-sm max-w-xs">Expert financial advice tailored to your needs.</p>
                    </div>
                    <Link href="/contact" className="flex items-center gap-4 mt-6 md:mt-0 group cursor-pointer">
                        ...
                        <ArrowRight className="h-8 w-8 text-navy-deep bg-white rounded-full p-2 group-hover:bg-gold group-hover:text-white transition-colors" />
                    </Link>
                </div>
            </div>
        </div>
