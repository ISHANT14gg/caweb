        ...
        <div className="bg-white">
            ...
            <div className="pt-20 pb-10 text-center">
                <ScrollAnimation direction="up">
                    <h1 className="text-4xl md:text-5xl font-serif font-bold text-navy-deep mb-4">Our Services</h1>
                            ...
                            <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col h-full">
                                ...
                                <div className="pt-12 pb-8 px-6 text-center flex-grow flex flex-col">
                                    ...
                                    <Link
                                        ...
                                        className="text-gold font-semibold text-sm uppercase tracking-wide hover:underline inline-flex items-center justify-center gap-1"
                                    >
            ...
            {/* CTA Section */}
            <div className="bg-navy relative overflow-hidden py-20">
                {/* Subtle background accents */}
                <div className="absolute top-0 right-0 w-96 h-96 bg-navy-light/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-navy-light/20 rounded-full blur-2xl translate-y-1/2 -translate-x-1/3"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <ScrollAnimation className="flex flex-col md:flex-row items-center justify-between gap-12" direction="up">
                        ...
                        <div className="md:w-1/2 text-left text-white">
                            ...
                            <Link
                                href="/contact"
                                className="inline-flex items-center px-8 py-4 bg-gold text-navy-deep font-bold rounded-sm shadow-lg hover:brightness-110 transition-all"
                            >
                        ...
                        <div className="md:w-1/2 flex justify-center md:justify-end">
                            <div className="w-64 h-64 border border-gold-muted/30 rounded-full flex items-center justify-center relative bg-navy-deep/50 backdrop-blur-sm">
                                <div className="w-48 h-48 bg-navy-light rounded-full flex items-center justify-center shadow-inner hover:scale-105 transition-transform duration-500">
            ...
            <div className="bg-navy-deep py-8 border-t border-navy">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
                    <div>
                        <h3 className="text-2xl font-bold text-white uppercase tracking-wider mb-1">CONSULT</h3>
                        <p className="text-gray-400 text-sm">Expert financial advice for your business growth.</p>
                    </div>
                    <Link href="/contact" className="group flex items-center text-white mt-4 md:mt-0">
                        ...
                        <div className="bg-white rounded-full p-1 transition-transform group-hover:translate-x-1">
                            <ArrowRight className="h-5 w-5 text-navy-deep" />
                        </div>
                    </Link>
                </div>
            </div>
