        ...
        <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col items-end gap-3">
            ...
            <AnimatePresence>
                {showTooltip && (
                    <motion.div
                        ...
                        className="hidden md:block bg-white rounded-xl shadow-xl border border-gray-100 px-4 py-3 mr-1 max-w-[210px] relative"
                    >
                        <button
            ...
            <div className="flex flex-col items-center gap-3">
                ...
                <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-10 h-10 md:w-12 md:h-12 bg-gray-800 text-white hover:bg-gray-700 transition-colors rounded-full shadow-lg flex items-center justify-center"
                    aria-label="Email us"
                >
                ...
                <motion.a
                    ...
                    onClick={() => setShowTooltip(false)}
                    className="w-12 h-12 md:w-14 md:h-14 bg-[#25D366] hover:bg-[#1fbe5d] rounded-full shadow-lg flex items-center justify-center transition-colors"
                    aria-label="Chat on WhatsApp"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 md:w-7 md:h-7 text-white">
